...
<head>
	...
	<title>Administrar Productos | <?php echo APPTITLE ?></title>
...
<body>
	...
	<main>
		...
		<section class="principal">
			<div class="principal-image" style='background-image: url("<?php echo SERVERURL?>images/nature10.jpg")'>
				<div>
		...
		<section class="proyectos">
			...
			<div class="opcionesAdmin">
				<a href="<?php echo SERVERURL ?>user/addproduct.php" title="Añadir Producto"><i class="fas fa-plus-circle"></i></a>
			</div>
					...
					if (count($proyects) > 0) { 
					 	...
					 	foreach ($proyects as $proyect){ ?>
							<div class="card">
								...
								<div class="body">
									<a  href="<?php echo SERVERURL ?>view.php?id=<?php echo $proyect['id']?>">Ver Producto</a>
