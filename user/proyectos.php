...
<head>
	...
	<title>Administrar Proyectos | <?php echo APPTITLE ?></title>
</head>
<body>
	...
	<main>
		...
		<section class="principal">
			<div class="principal-image" style='background-image: url("<?php echo SERVERURL?>images/nature11.jpg")'>
				<div>
					<p>Administrar los proyectos</p>
				</div>
		...
		<section class="proyectos">
			<div class="opcionesAdmin">
				<a href="<?php echo SERVERURL?>user/addproyect.php" title="Añadir Proyecto"><i class="fas fa-plus-circle"></i></a>
			</div>
